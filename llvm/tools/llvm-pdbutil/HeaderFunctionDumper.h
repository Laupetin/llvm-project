...
#ifndef LLVM_TOOLS_LLVMPDBDUMP_HEADERFUNCTIONDUMPER_H
#define LLVM_TOOLS_LLVMPDBDUMP_HEADERFUNCTIONDUMPER_H
...
class HeaderFunctionDumper : public PDBSymDumper {
public:
  HeaderFunctionDumper(LinePrinter &P);
